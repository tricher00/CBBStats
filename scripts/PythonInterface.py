...
def updateDb():
    ...
    sm = input("Would you like to insert games for a (s)ingle day or (m)ultiple days? (s/m): ")
...
def schedule():
    date = input("What date would you like to get the schedule for? (YYYY-MM-DD): ")
    games = getSched(date)
...
def getPlayer():
    ...
    lineType = input("Would you like the (f)ull line or the (s)imple line? (f/s): ")
...
def leaderboard():
    stat = input("Please enter a stat: ")
    limit = input("How many players would you like to see?: ")
